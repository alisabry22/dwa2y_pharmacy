...
import 'package:dwa2y_pharmacy/Widgets/custom_dashboard_container.dart';
                    ...
                    child: Column(
                        ...
                        children: [
                              ...
                              child: StreamBuilder<
                                  ...
                                  builder: (context, snapshot) {
                                    if (snapshot.connectionState ==
                                      ...
                                      return Center(
                                        child:
                                            Text("Please Add More Products".tr),
                                      );
                                    }
                                  }),
                            ),
                          ...
                          Expanded(
                                                              ...
                                                              children: [
                                                                        Obx(()=>
                                                                                  CustomDashboardContainer(
                                                                                    text: "Total Products".tr,
                                                                                    icon: Icon(Icons.medical_services),
                                                                                    totalnumber: controller.totalProducts.value.toString(),
                                                                                  ),
                                                                                ),
                                                                                SizedBox(width: 15,),
                                                                                  Obx(()=>
                                                                                    InkWell(
                                                                                      ...
                                                                                      child: Ink(
                                                                                        ...
                                                                                        totalnumber: controller.totalDelivered.value.toString(),
                                                                    ),
                                                                                      ),
                                                                                    ),
                                                                                  ),
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                                  ...
                                                                                  Obx(()=>
                                                                                    InkWell(
                                                                                      ...
                                                                                      child: Ink(
                                                                                        ...
                                                                                        totalnumber: controller.TotalPending.value.toString(),
                                                                    ),
                                                                                      ),
                                                                                    ),
                                                                                  ),
                                                                                  ...
                                                                                  Obx(()=>
                                                                                    ...
                                                                                    totalnumber: "${controller.totalMoney.value.toString()}${"L.E".tr}",
                                                                ),),
                                                              ],
                                                            ),
                                                          ),
                            ...
                            //   CustomDashboardContainer(
                            //   text: "Top Customer".tr,
                            //   icon: Icon(Icons.support_agent),
                            //   totalnumber: 10.toString(),
                            // ),
